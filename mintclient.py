...
try:
#    api_response = api_instance.get_model_version(model_version_id, username=username)
#    pprint(api_response)
...
model_config_id = "sscyp_historgram_output"
try:
    api_response = api_instance.get_model_configuraton(model_config_id)
    pprint(api_response)
